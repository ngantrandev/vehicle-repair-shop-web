...
const columns = [
    ...
    { id: 'id', label: 'Mã đơn xuất', minWidth: 20 },
    { id: 'date_input', label: 'Ngày xuất', minWidth: 120 },
    {
        id: 'total_price',
        label: 'Tổng giá trị',
        minWidth: 120,
...
function createData(stt, id, date_output, total_price, booking_id) {
    return { stt, id, date_input: date_output, total_price, booking_id };
}
                ...
                <div className='grid w-full grid-cols-2 px-4'>
                    <div className='p-4'>
                        <p className='font-bold'>
                            Mã phiếu xuất: {selectedNote?.id}
                        </p>
                        <p className='font-bold'>
                            Ngày xuất: {selectedNote?.date_output}
                        </p>
                    </div>
                    <div className='p-4'>
                        <p className='font-bold'>
                        ...
                        <p className='font-bold'>
                            Mã lịch hẹn: {selectedNote?.booking_id}
                        </p>
                    </div>
                </div>
                        ...
                        <Table stickyHeader aria-label='sticky table'>
                            ...
                            <TableBody>
                                {selectedNote?.items?.map((item, index) => {
                                    const { item_id, item_name, count, price } =
                                        item;
                                    return (
                                        <TableRow
                                            hover
    ...
    useEffect(() => {
        const rows = [
            ...notes.map((item, index) => {
                const { id, date_output, total_price, booking_id } = item;
