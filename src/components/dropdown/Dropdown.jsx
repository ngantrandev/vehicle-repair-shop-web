...
function Dropdown({
    ...
    const [selectedItem, setSelectedItem] =
        useState(0); /**index of selected item */
    ...
    return (
        <div className={`relative ${className}`}>
            <button
                ...
                className='inline-flex w-full min-w-28 items-center rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300'
                type='button'
